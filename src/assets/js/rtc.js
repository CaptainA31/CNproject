...
window.addEventListener('load', () => {
    ...
    // Check if the room parameter is present in the URL
    if (!room) {
        document.querySelector('#room-create').attributes.removeNamedItem('hidden');
    } else if (!username) {
        document.querySelector('#username-set').attributes.removeNamedItem('hidden');
    } else {
        // Show room communication elements
        ...
        // Function to broadcast new tracks
        ...
        // Function to toggle recording icons
        ...
        // Event listener for chat textarea
        ...
        // Event listener for recording screen
        ...
        // Event listener for recording own video
